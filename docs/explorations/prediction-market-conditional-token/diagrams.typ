...
#let mint_set_tx = vanilla_transaction(
  ...
  inputs: (
    (
      ...
      wallet: true,
      address: "bettor_addr",
      value: ("Collateral": "N", "ADA": "market_fee"),
    ),
    (
      reference: true,
      name: "Outcome",
...
#let burn_set_tx = vanilla_transaction(
  ...
  inputs: (
    (
      ...
      wallet: true,
      address: "bettor_addr",
      value: ("YES_market_id": "k", "NO_market_id": "k", "ADA": "market_fee"),
    ),
    (
      name: "Redemption",
      address: "redemption_script",
  ...
  outputs: (
    (
      name: "Redemption",
      address: "redemption_script",
      value: ("Collateral": "N - k", "ADA": "market_fee"),
      datum: (
        market_id: "ByteArray",
        beacon_policy: "PolicyId",
      ),
...
#let redeem_tx = vanilla_transaction(
  ...
  inputs: (
    ...
    (
      ...
      wallet: true,
      address: "bettor_addr",
      value: ("YES_market_id": "k", "ADA": "market_fee"),
    ),
  ),
  mint: (
    "YES_market_id": "-k",
...
#let refund_tx = vanilla_transaction(
  ...
  inputs: (
    (
      ...
      wallet: true,
      address: "bettor_addr",
      value: ("YES_market_id": "m", "NO_market_id": "n", "ADA": "market_fee"),
    ),
    (
      name: "Redemption",
      address: "redemption_script",
  ...
  outputs: (
    (
      name: "Redemption",
      address: "redemption_script",
      value: ("Collateral": "N - (m + n) / 2", "ADA": "market_fee"),
      datum: (
        market_id: "ByteArray",
        beacon_policy: "PolicyId",
      ),
